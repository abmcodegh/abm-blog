![Jmix1.3 发布](_media/jmix_1.3.png ":class=title-image")
...
![jmix FlowUI 预览](_media/jmix_1.3_flowui_responsive.gif ":class=center-eighty-image")
...
![Jmix AWS 部署](_media/jmix_1.3_aws_deployment.png ":class=center-eighty-image")
...
![Studio JPQL designer](_media/jmix_1.3_jpql.gif ":class=center-eighty-image")
...
![Studio Liquibase Changelog](_media/jmix_1.3_lbcl.gif ":class=center-eighty-image")

## BPM 改进

我们花了很多努力用于提升 Studio 中的 BPMN 设计器，现在它已经和运行时的设计器功能相当，提供与源代码的紧密集成。

![Studio BPMN designer](_media/jmix_1.3_bpm.gif ":class=center-eighty-image")
...
![Role management](_media/jmix_1.3_role_filter.png ":class=center-eighty-image")

行级策略编辑器现在提供针对 JPQL 语句的代码完成功能、语法检查操作以及文档链接操作。

![Row-level policy enhancement](_media/jmix_1.3_row_level_policy_add.gif ":class=center-eighty-image")
