...
乍一看，您可能觉得这是一种低代码平台。但实际上，Jmix 更加灵活，且具有低代码平台无法提供的自由度：您可以**完全掌控**使用 Jmix 开发的每一个应用系统。使用 Jmix 开发的应用系统无需按照终端用户的数量进行付费，也没有供应商锁定问题。Jmix 将源代码放在第一位，是真正的、开源的“少代码”业务系统开发框架。来自开发者，服务于开发者。
...
![Picture1](_media/jmix_new_eff1.png)
...
![Picture2](_media/jmix_new_eff2.png)
...
![Picture4](_media/jmix_new_eff3.png)
