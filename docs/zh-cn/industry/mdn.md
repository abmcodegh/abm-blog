...
![现代化改造还是数字化转型](./_media/mdn/mdn_or_dt.svg) {.center .size-4 .float-l}
...
![开始现代化改造](./_media/mdn/mdn_start.svg) {.center .size-4 .float-l}
...
![开始现代化改造](./_media/mdn/mdn_jmix.png) {.center .size-5 .float-r}
