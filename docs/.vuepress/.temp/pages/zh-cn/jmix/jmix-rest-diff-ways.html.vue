<template><div><p>很多应用是采取前后端分离的方式进行开发。这种模式下，对前端的选择相对灵活，Jmix 的一种典型应用场景就是作为这种类型应用程序的高级别管理 UI 和后端。为此，Jmix 提供了强大的通用 REST API 功能。</p>
<!-- more -->
<p class="center size-8 radius shadow"><img src="https://cdn.abmcode.com/zh-cn/jmix/_media/jmix-rest-diff-ways/jmix-rest-api.png" alt="rest api" loading="lazy"></p>
...
<p>实体通过 Jmix Studio 创建可以选择其他<a href="https://docs.jmix.cn/jmix/data-model/entities.html#traits" target="_blank" rel="noopener noreferrer">实体特性<ExternalLinkIcon/></a>，比如版本、实体审计、软删除属性等。</p>
</div>
...
<p class="custom-container-title">提示</p>
<p>这里的加载实体列表代码，我们通过 Studio 的<a href="https://docs.jmix.cn/jmix/studio/code-snippets.html" target="_blank" rel="noopener noreferrer">代码段<ExternalLinkIcon/></a>功能自动添加。</p>
</div>
...
<p class="center size-5 shadow"><img src="https://cdn.abmcode.com/zh-cn/jmix/_media/jmix-rest-diff-ways/service_api_flow.png" alt="Jmix 服务 API 流程" loading="lazy"></p>
...
<p class="center size-8 shadow"><img src="https://cdn.abmcode.com/zh-cn/jmix/_media/jmix-rest-diff-ways/postman_service_call.png" alt="Postman 调用服务 API" loading="lazy"></p>
<div class="custom-container danger">
<p class="custom-container-title">API 安全机制</p>
...
<p class="center size-8 shadow"><img src="https://cdn.abmcode.com/zh-cn/jmix/_media/jmix-rest-diff-ways/postman_controller_call.png" alt="Postman 调用控制器 API" loading="lazy"></p>
